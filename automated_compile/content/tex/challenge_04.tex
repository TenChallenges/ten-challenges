...
Let $G$ and $H$ be simple graphs, with $G$ nonempty.
%\phantom{a}
\begin{enumerate}
...
For every bipartite graph $H$ and for any nonempty graph $G$, we have:
$$
...
Let $r \in \N$. For every bipartite graph $H$ that admits a bipartition $V\ev{H} = X \cup Y$ with $|X| \leq r$ and $|Y| \leq r$ and for any nonempty graph $G$, we have:
$$
t_H\ev{G} \geq t_{K_2}\ev{G}^{|E\ev{H}|}
$$
\end{openproblem}
