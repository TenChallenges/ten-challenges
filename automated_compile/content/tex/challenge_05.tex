...
\section*{Challenge 5: Erdős--Hajnal Conjecture for paths}
...
Let $r\in \mathbb{N}$. There is some $c_r > 0$ such that every $P_r$-free graph $G$ with $n$ vertices has a clique or independent set of size at least $n^{c_r}$.
\end{conjecture}

The conjecture has been proved for $r=5$ by Nguyen, Scott and Seymour in \cite{nguyen2026induced}
